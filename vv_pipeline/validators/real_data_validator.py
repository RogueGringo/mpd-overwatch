...
# ---------------------------------------------------------------------------
# Path setup -- allow imports from mpd_command root
# ---------------------------------------------------------------------------
_THIS_DIR = os.path.dirname(os.path.abspath(__file__))
_VALIDATORS_DIR = os.path.dirname(_THIS_DIR)
_VV_DIR = os.path.dirname(_VALIDATORS_DIR)
_PROJECT_DIR = os.path.dirname(_VV_DIR)

# Walk up to mpd_command root
# _THIS_DIR     = .../mpd_command/vv_pipeline/validators
# _PROJECT_DIR  = .../mpd_command
if _PROJECT_DIR not in sys.path:
    sys.path.insert(0, _PROJECT_DIR)

from data.las_parser import LASParser, LASResult

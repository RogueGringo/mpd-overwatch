...
def page_topology():
    ...
    from data.demo_generator import generate_demo_well_data
    from core.pointcloud.ingestion import ingest_dataframe
    ...
    try:
        from core.pointcloud.sheaf_analysis import CoherenceAnalyzer, coherence_log

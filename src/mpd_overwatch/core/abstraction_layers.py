...
try:
    from mpd_overwatch.pointcloud.distance import cross_channel_distance, pairwise_distance_matrix
...
# --- Zone Intelligence ---
try:
    from mpd_overwatch.core.zone_intelligence import ZoneIntelligenceEngine, ZoneConfig
...
# --- Proposal Generator ---
try:
    from mpd_overwatch.core.proposal_generator import generate_proposal, WellProposal
    _HAS_PROPOSAL = True
except ImportError:
    _HAS_PROPOSAL = False

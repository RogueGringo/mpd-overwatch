...
MNEMONIC_MAP = {
    ...
    "DATETIME": "timestamp",
    # ---- Pason :N specific (base mnemonic is ambiguous across suffixes) ----
    "ROTA:1": "rpm", "ROTA:2": "torque",
    "TOP:1": "rpm", "TOP:2": "torque",
    "MUD:1": "mud_volume", "MUD:2": "mud_weight",
    "FLOW:1": "flow_in", "FLOW:2": "flow_out_pct", "FLOW:4": "flow_out",
    "BIT:1": "wob",
    "PUMP:4": "spp", "PUMP:5": "spp",
    "STAN:1": "spp", "STAN:2": "spp",
    "TVD:1": "tvd", "TVD:2": "tvd", "TVD:3": "tvd",
    "TIME:1": "timestamp",
    "HOLE:1": "depth_md",
    "BLOC:1": "block_position",
    "TEMP:1": "temperature",
    "GAMM:2": "gamma_ray",
    "DOG:1": "dls",
    "MPD:2": "choke_pressure", "MPD:5": "choke_pressure",
    "MPD:9": "casing_pressure",
    "MSE:1": "mse", "MSE:2": "mse",
    "GAIN:1": "flow_out",
    "PIT:1": "mud_volume",
    "SVY:1": "azimuth", "SVY:3": "inclination",
    # ---- Missing base mnemonics (Pason, Totco, generic) ----
    "GAMA": "gamma_ray", "GAMM": "gamma_ray",
    "STAN": "spp", "STPP": "spp",
    "CHOK": "choke_pressure",
    "CASI": "casing_pressure",
    "HKLX": "hookload",
    "TQX": "torque",
    "TFLO": "flow_out",
    "ANN": "apwd",
    "WELL": "casing_pressure",
    "BACK": "choke_pressure",
}
